...
(function () {
    ...
    URL = "http://kg.tgov.cn/lib/ueditor/";
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,toolbars:[
            ['undo', 'redo', '|','bold', 'italic', 'underline', 'strikethrough', 'superscript', 'subscript', 'removeformat', 'formatmatch', '|',
                'blockquote', '|', 'pasteplain', '|', 'forecolor', 'backcolor','link','help']
        ]
