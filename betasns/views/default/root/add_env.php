...
<table>
	<tr>
		<td>名称</td>
		<td width=“75%”><input name='name' type="text" class="novoid" style="width: 300px;" /><span></span></td>
	</tr>
	<tr>
		<td width="50px">值</td>
		<td width=“75%”><input name='value' type="text" class="novoid" style="width: 300px;" /><span></span></td>
	</tr>
	<tr>
		<td>&nbsp;</td>
